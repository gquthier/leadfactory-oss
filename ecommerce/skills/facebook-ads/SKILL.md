---
name: facebook-ads
description: Meta Ads (Facebook & Instagram) platform expertise. Audit campaigns,
  audiences, creative strategy, pixel tracking, and CAPI. Use when the user asks about
  Facebook Ads, Instagram Ads, Meta Ads, social media advertising, Advantage+ campaigns,
  or Meta pixel/CAPI setup.
license: MIT
metadata:
  version: 1.0.0
  category: paid-media
  ...
  updated: 2026-03-11
  tested: 2026-03-17
  tested_with: Codex v2.1
  upstream: thatrebeccarae/claude-marketing
---
...
Ce skill est déjà inclus dans le coffre du template.
...
For detailed Meta Ads API reference, pixel implementation, and advanced configurations, see [references/REFERENCE.md](references/REFERENCE.md).
...
When performing an account audit, load `references/scoring-system.md` for the weighted scoring algorithm and `references/CHECKS.md` for the 46-check Meta Ads audit checklist. Produce a health score (0-100, grade A-F) with Quick Wins and a prioritized action plan.
