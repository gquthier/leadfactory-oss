...
description: Manage Google Ads — performance, keywords, bids, budgets, negatives,
  ...
  asset management, portfolio bidding, offline conversions. Use for any mention of
  Google Ads, CPA, ROAS, ad spend, or campaign settings.
license: MIT
metadata:
...
Read and follow `references/shared/preamble.md` — handles MCP detection, account selection, and config. Once cached, this is instant.

Then read `references/shared/analysis-principles.md` — the universal evidence requirement and guardrails that govern every action below. Treat them as non-negotiable.
