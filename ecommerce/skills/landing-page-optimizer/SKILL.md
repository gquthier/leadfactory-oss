...
description: Landing page audit and optimization for conversion. Covers above-the-fold
  design, value propositions, CTAs, social proof placement, form design, page speed,
  and mobile optimization. Use when the user asks about landing page optimization,
  conversion rate improvement, page audits, or CTA optimization.
license: MIT
metadata:
  version: 1.0.0
  category: growth
