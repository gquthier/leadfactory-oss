...
These historical upstream figures are illustrative, not current benchmarks or observations made by this template. Do not automatically inflate them for a later year. Verify dated sources and compare against the owner’s measured account data.
